...
public class DisplaySetRoylloNFT2Test extends BaseTest {
    ...
    @DisplayName("Check setRoylloNFT2 asset page")
    void assetPage(final HttpHeaders headers) throws Exception {
        final DecodedProofValueResponse.DecodedProof assetFromTest = SET_OF_ROYLLO_NFT_2_FROM_TEST.getDecodedProofResponse(0);

        mockMvc.perform(get("/asset/" + SET_OF_ROYLLO_NFT_2_ASSET_ID).headers(headers))
                ...
                // Proof files.
                .andExpect(content().string(containsString(">" + SET_OF_ROYLLO_NFT_2_FROM_TEST.getDecodedProofRequest(0).getRawProof() + "<")))
                // Error messages.
                ...
                .andExpect(content().string(not(containsString(Objects.requireNonNull(
                        ...
                        .replace("\"{0}\"", "&quot;" + SET_OF_ROYLLO_NFT_2_ASSET_ID + "&quot;")))));
    }
