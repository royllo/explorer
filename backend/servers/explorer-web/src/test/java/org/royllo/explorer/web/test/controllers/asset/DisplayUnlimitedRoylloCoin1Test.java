...
public class DisplayUnlimitedRoylloCoin1Test extends BaseTest {
    ...
    @DisplayName("Check unlimitedRoylloCoin1 asset page")
    void assetPage(final HttpHeaders headers) throws Exception {
        final DecodedProofValueResponse.DecodedProof assetFromTest = UNLIMITED_ROYLLO_COIN_1_FROM_TEST.getDecodedProofResponse(0);

        mockMvc.perform(get("/asset/" + UNLIMITED_ROYLLO_COIN_1_ASSET_ID).headers(headers))
                ...
                // Proof files.
                .andExpect(content().string(containsString(">" + UNLIMITED_ROYLLO_COIN_1_FROM_TEST.getDecodedProofRequest(0).getRawProof() + "<")))
                // Error messages.
                ...
                .andExpect(content().string(not(containsString(Objects.requireNonNull(
                        ...
                        .replace("\"{0}\"", "&quot;" + UNLIMITED_ROYLLO_COIN_1_ASSET_ID + "&quot;")))));
    }
